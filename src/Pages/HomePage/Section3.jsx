...
const Section3 = () => {
  return (
    <div className='h-[1200px] font-Gordita position-fixed' style={{ backgroundImage: `url(${cf})`, backgroundSize: "cover", backgroundPosition: "center" }}>
    <div className='mt-[100px]'>
        <div className=' h-auto pb-10 mt-[50px]'>
          <h2 className=' text-center py-20 text-[20px] md:text-[26px] lg:text-[36px] text-white font-medium pb-10 '>Translation Process</h2>
